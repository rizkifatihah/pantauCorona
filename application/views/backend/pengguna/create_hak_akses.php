     ...
     <div class="row">
       ...
       <div class="col-md-12">
         ...
         <div class="card card-success">
           ...
           <!-- /.card-header -->
           <!-- form start -->
           <form class="form-horizontal" method="post" action="<?php echo base_url('backend/pengguna/create_hak_akses/do_create/');?>" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                  <input type="text" name="nama_hak_akses" class="form-control" placeholder="Nama Hak Akses" required>
              </div>
              <div class="form-group">
              <?php foreach ($parentModul as $key): ?>
                  <div class="card">
                    ...
                    <div class="card-body d-none" id='ParentModul<?php echo $key->id_parent_modul;?>'>
